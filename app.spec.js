...
describe('App', () => {
  ...
  test('when a standard user is at the center of Paris, and looks for the cheapest offer in hotels around for the date 11/01/2021, an hotel is found', () => {
    expect(app.findHotelNearbyWithBestOfferForUser(48.856564, 2.351711, 2000, '15/01/2021', 1).ridCode).toBeDefined();
  });
});
